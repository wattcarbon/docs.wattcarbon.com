...
An updated CSV template with the correct column names [is available here](https://api.wattcarbon.com/assets/csv/template/electrification_eemetered) and timeseries description [is available here](https://api.wattcarbon.com/#tag/Meters/operation/Meters-upload_meter_intervals).

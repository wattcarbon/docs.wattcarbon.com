...
**Asset** - The term describing the energy intervention that results in EACs, such as a solar panel, battery, demand response event, or whole building that underwent an energy efficiency upgrade.
...
The fields required at the asset level will vary based on type of asset. The [CreateAsset](https://api.wattcarbon.com/#tag/Assets/operation/Assets-create_asset) endpoint can be used to create individual assets, and this page allows you to toggle to the asset kind to see changing required fields based on asset kind.

If you prefer, you can also use the bulk [CreateAssets](https://api.wattcarbon.com/#tag/Assets/operation/Assets-create_assets) endpoint to upload an array of assets that are of the same kind via a CSV file. For details on this approach please contact us.
